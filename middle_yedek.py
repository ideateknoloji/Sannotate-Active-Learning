...
def receive_webhook(df=df):
    ...
    if request_count == limit:
        ...
        counter_for_print = 0
        file_names = os.listdir("c:\\Users\\ufuk.cefaker\\Desktop\\bottle_image_data\\Full  Water level\\Full  Water level\\")
        for tr_image in tr_unique_imgs:

            #print("TRAINING COPYING IMAGE for  ",tr_image)
            print("TRAINING COPYING IMAGE for  ",file_names[counter_for_print])

            #file_names[counter_for_print]
            


            image_path = "c:\\Users\\ufuk.cefaker\\Desktop\\bottle_image_data\\Full  Water level\\Full  Water level\\" + file_names[counter_for_print]
            #image_path = "c:\\Users\\ufuk.cefaker\\Desktop\\bottle_image_data\\Full  Water level\\Full  Water level\\" + tr_image[9:]

            #c:\\Users\\ufuk.cefaker\\Desktop\\data\\18
            ...
            sftp.put(image_path, "train_media/" + file_names[counter_for_print])
